...
class KataGoGTP:
    ...
    def analyze(
        self, next_player: str, visits: int, top_n: int = 3
    ) -> Tuple[List[MoveCandidate], Optional[List[float]]]:
        """
        ...
        Returns:
            Tuple of (List of MoveCandidate objects, Optional ownership array)
        """
        import time
        import select
